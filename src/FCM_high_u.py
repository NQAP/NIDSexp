...
def fcm_cluster(X, n_clusters, m):
    ...
    return cluster_labels, u, fpc

# -----------------------------
# 3. 聚類
# -----------------------------
print("cluster start!")
cluster_labels, u, _ = fcm_cluster(X, n_clusters=166, m=1.013)
df_majority["ClusterLabel"] = cluster_labels
print(df_majority["ClusterLabel"].value_counts())
print("cluster done!")
...
df_final.to_csv("./extra_dataset/major_after_reduced_high_membership.csv", index=False)
